...
export const SideBarNameAndImage = () => {
    ...
    return (
        <div className="w-full scroll-div overflow-auto lg:w-1/3 flex flex-col gap-5 sm:justify-center items-center rounded-lg  p-10 bg-[#181818]">
            ...
            <h1 className='text-[#ff4191] flex flex-col gap-3 text-center'>
                ...
                <Tooltip title='Linkedin' placement="bottomLeft" color='#ff4191'>
                    <span>
                        <a
                            href={urls.linkedin}
                            target='_blank'
                            className="text-white hover:text-[#ff4191] border cursor-pointer hover:border-[#ff4191] text-center block text-2xl p-2 rounded transition duration-200"
                        >
            ...
            <div className='flex w-full pt-5 gap-5 justify-center text-white'>
                <a href={CV} target='_blank' className='w-6/12 text-center bg-[#222222] p-3 rounded-lg'>
                    Ver CV
                </a>
                <a href={urls.whatsapp} target='_blank' className='w-6/12  text-center bg-[#222222] p-3 rounded-lg'>
                    Contactame
                </a>
